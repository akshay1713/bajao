...
parser.add_argument('-d', '--dir', default='',
                    help="The directory from which all mp3 files are to be added to Bajao Music Library")
parser.add_argument('-pn', '--playlist-name', default='',
                    help="The name of the playlist to be created")
parser.add_argument('-s', '--songs', default='', nargs='*',
                    help="Songs to be added. Also accepts directories.")
